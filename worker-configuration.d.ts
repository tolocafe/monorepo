/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0305b7c9a3fddde0b3fc41f18558e90f)
// Runtime types generated with workerd@1.20251217.0 2025-09-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./apps/workers/index')
	}
	interface Env {
		KV_OTP: KVNamespace
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<
			...
			| 'CLOUDFLARE_D1_TOKEN'
			| 'GOOGLE_SERVICE_WALLET_EMAIL'
			| 'GOOGLE_SERVICE_WALLET_PRIVATE_KEY'
			| 'APNS_PRIVATE_KEY'
			| 'APNS_TEAM_ID'
			| 'APNS_KEY_ID'
		>
